...
Two different models have been searched for. Both models deal with the CRC circuit, but they use different models.
...
This is the other model that has been created by the second article [4].

From both models, 6 proteins were extracted. Since these are the most important or have the most influence. These 6 proteins are: Acaete-Scute (AS-C), Hairy, Senseless (SENS), Scratch (SCRT), Charlatan (CHN), Phyllopod (PHYL). These are shown in the graphs

Daughterless (DA), Extramacrochaete (EMC), Groucho (GRO), Seven in one (SINA) and Ubiquitin (UB) are also important proteins, but the content of these is almost unchanged, shown by study [3].
...
This is the differential equation of the first article [1]:
...
pander(c('dt_x = dt_y = dt_z = dt_u = dt_w = dt_p = u0 = w0 = p0 -> 0','Gro = EMC = C = m1 = m2 = m3 = m4 = m5 = m6 = m7 = L = kx = ky = kz = ku = kw = kp -> 1','D -> 2.05','UB -> 1.17','SINA -> 5.6','n1 = n3 = n5 -> 2','a3 ->  3.61','b3 -> 4.96','c3 -> 1.35','a4 -> 4.43','b4 -> 6.09','c4 -> 1.66','a5 -> 8.09','b5 -> 11.13','c5 -> 3.03','a6 -> 2.67','b6 -> 3.67','c6 -> 1.00','d1 -> 7.46','d3 -> 2.77','d5 -> 1.24','y0 -> 3','x0 = z0 -> 3 / 20'))
```
