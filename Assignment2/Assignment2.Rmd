...
par(mfrow=c(2,2))
plot(out[,"Rm0"], type = "l", lwd = 1, ylab="receptor mRNA", xlab="time", xlim=c(0, 48), ylim=c(2, 5))
plot(out[,"R0"], type = "l", lwd = 1, ylab="free receptor density", xlab="time", xlim=c(0, 48), ylim=c(100, 300))
plot(out[,"DR"], type = "l", lwd = 1, ylab="drug-receptor complex", xlab="time", xlim=c(0, 48), ylim=c(0, 25))
plot(out[,"DRn"], type = "l", lwd = 1, ylab="activated receptor complex", xlab="time", xlim=c(0, 48), ylim=c(0, 25))
